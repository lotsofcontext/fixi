...
Este prompt es el **north star** del proyecto. Está replicado en `CLAUDE.md` con el checklist de capabilities no-negociables que exige, de modo que cada sesión de Claude Code lo tenga siempre a la vista.
