...
> **Última actualización**: 2026-04-07 00:43:12
...
|----|------|--------|-----|----------|-----------|
| [[S1-T05]] | Sembrar BUG #1 — DivideByZero en CalculadoraConsumo | S1 | D1 | P1 | 30m |
| [[S1-T06]] | Sembrar PERF #2 — N+1 en MedidorService.ListarConResumen | S1 | D1 | P1 | 45m |
| [[S1-T07]] | Sembrar SECURITY #3 — AdminController sin [Authorize] | S1 | D1 | P1 | 20m |
| [[S1-T08]] | Tests que fallan para los 3 bugs sembrados | S1 | D1 | P1 | 1h30m |
| [[S1-T09]] | Pre-crear 3 work items markdown en docs/issues/ | S1 | D2 | P1 | 1h |
| [[S1-T11]] | README bilingüe del demo repo | S1 | D2 | P1 | 45m |
| [[S1-T12]] | Rehearsal Fixi contra WI-101 → run-01-github.md | S1 | D2 | P1 | 1h30m |
| [[S1-T13]] | Agregar parser Azure DevOps Work Items al SKILL.md | S1 | D3 | P1 | 45m |
| [[S1-T14]] | Agregar Azure Repos PR creation al SKILL.md | S1 | D3 | P1 | 45m |
| [[S1-T15]] | Rehearsal Fixi contra WI-102 y WI-103 (path Azure DevOps) | S1 | D4 | P1 | 2h |
| [[S1-T16]] | Terraform skeleton en fixi/terraform/ | S1 | D4 | P1 | 2h |
